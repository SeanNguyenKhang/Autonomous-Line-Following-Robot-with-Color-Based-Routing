...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, BIN2_Pin|BIN1_Pin|AIN1_Pin|AIN2_Pin
                          |TCS_S2_Pin|TCS_S3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, TCS_S0_Pin|TCS_S1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : BIN2_Pin BIN1_Pin AIN1_Pin AIN2_Pin
                           TCS_S2_Pin TCS_S3_Pin */
  ...
  /*Configure GPIO pins : TCS_S0_Pin TCS_S1_Pin */
